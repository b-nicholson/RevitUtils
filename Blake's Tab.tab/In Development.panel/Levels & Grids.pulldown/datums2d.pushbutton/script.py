# -*- coding: utf-8 -*-
"""Sets Levels and Grids to Have their extents as 2D (view specific)"""

__title__ = 'Make Datums 2D in View'
...
t = DB.Transaction(doc, "Make Grids 2D")
t.Start()
for grid in grid_selector:
    ...
    if grid_is_editable is True:
        grid.SetDatumExtentType(DB.DatumEnds.End0, activeView,DB.DatumExtentType.ViewSpecific)
        grid.SetDatumExtentType(DB.DatumEnds.End1, activeView, DB.DatumExtentType.ViewSpecific)
t.Commit()
